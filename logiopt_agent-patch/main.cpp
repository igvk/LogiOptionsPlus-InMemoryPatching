...
const byte *logioptions_target_code = logioptions_target_code_V206;
const byte *logioptions_hook_code = logioptions_hook_code_V206;
#ifdef CODE_CAVE
...
extern "C"
{
    ...
    extern bool target_handler_V206(const char* name, size_t length);
...
int main()
{
    ...
    const bool result = target_handler_V206(PROGRAM_NAME_CHARS, sizeof PROGRAM_NAME_CHARS);
